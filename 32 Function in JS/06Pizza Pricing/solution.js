...
//     function calculateTotalPrice(toppings, quantity) {
//         const toppingCost = toppings.length * 1.50;
//         const basePrice = basePrices[size.toLowerCase()];
//         const totalPrice = (basePrice + toppingCost) * quantity;
//         return totalPrice.toFixed(2);
//     }

//     return function (toppings) {
//         return function (quantity) {
//             return calculateTotalPrice(toppings, quantity);
//         };
//     };
// }
...
// const calculateTotal = calculatePrice(["cheese", "pepperoni"]);
// const totalPrice = calculateTotal(3); 
